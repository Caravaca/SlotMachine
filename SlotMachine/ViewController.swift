...
//  SlotMachine
//
//  Created by Antonio Caravaca Vega on 17/12/14.
...
class ViewController: UIViewController {
    ...
    // Information Labels on 3rd container
    ...
    // Array of arrays for the slots in the second container
    ...
    func setupSecondContainer(containerView: UIView) {
        ...
        for var columnNumber = 0; columnNumber < kColumns; columnNumber++ {
            
            for var rowNumber = 0; rowNumber < kRows; rowNumber++ {
                
                var slot:Slot
                var slotImageView = UIImageView()
                
                if slots.count != 0 {
                    let slotContainer = slots[columnNumber]
    ...
    func setupFourthContainer(containerView: UIView) {
        ...
        betOneButton.titleLabel?.font = UIFont(name: "Superclarendon-Bold", size: 14)
